...
public class SparkFunOTOS extends I2cDeviceSynchDevice {
    ...
    protected void poseToRegs(byte[] rawData, Pose2d pose, double xyToRaw, double hToRaw) {
        ...
        short rawX = (short) (pose.position.x * xyToRaw / _meterToUnit);
        short rawY = (short) (pose.position.y * xyToRaw / _meterToUnit);
        short rawH = (short) (pose.heading.toDouble() * hToRaw / _radToUnit);
